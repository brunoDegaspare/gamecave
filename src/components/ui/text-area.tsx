  ...
  return (
    <label className={clsx("block space-y-2", containerClassName)}>
      ...
      <textarea
        ...
        className={clsx(
          "bg-base-200 gc-placeholder w-full min-h-[120px] rounded-lg px-3 py-2 text-base-content/70 placeholder-base-content/50 focus:bg-base-200/70 focus:outline-none focus:ring-2 focus:border-primary focus:ring-primary transition-all duration-300 ease-in-out placeholder:transition-opacity placeholder:duration-200 placeholder:ease-out",
          shouldShowError
