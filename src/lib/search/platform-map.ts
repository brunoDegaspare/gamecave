type PlatformMapEntry = {
  aliases: string[];
  igdbIds: number[];
  dbNames: string[];
};

export const PLATFORM_MAP: PlatformMapEntry[] = [
  {
  ...
  {
    aliases: ["famicom disk system", "famicom", "fds"],
    igdbIds: [51],
  ...
  {
    aliases: ["atari jaguar cd", "jaguar cd"],
    igdbIds: [410],
